...
%TODO Rewrite this subsection after experiment 7_x with model 1 have been completed and compared to 7_x of model 5 -> if similar, add all training and validation images to the training and validation sets of the next incremental run for model 1
