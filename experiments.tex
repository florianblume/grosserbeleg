...
\noindent\textbf{TIFF.} \textit{Tagged image file format} is digital image format that supports 32-bit floating point values. This is the reason why this format was chosen as the container for the ground-truth object coordinates. \\
