...
\end{tabular}
\caption{The configuration of the SGD optimizer used in the experiment to compared SGD and Adam.}\label{table:experiments_optimizers_sgd}
\end{table}  
...
\subsection{Online Learning} \label{subsection:training_strategies}
