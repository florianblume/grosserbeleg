...
\begin{figure}[!tbp]
	...
	\end{subfigure}
	\caption{Training and validation losses of the active training method compared to training from scratch. The spike of the blue and purple error curves in the left graph are located where the training using the new images begins.}
