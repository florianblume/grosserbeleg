...
\end{tabular}
	\caption{The table shows the time the author needed to recover a single pose in an image using \ac{6dpat}. Images were taken from test scene 7 of the T-Less dataset. The measurements shall give an impression of the tool's efficiency, without making the claim to resemble an empirical study.} 
